...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            <div><a class="navbar-brand" style="font-size:32px;" href="user.html">众筹平台 - 资质管理</a></div>
        </div>
                ...
                <div class="panel-body">
                    <form id="addForm">
                        <div class="form-group">
                            <label for="fname">证件名称</label>
                            <input type="text" class="form-control" id="fname" placeholder="请输入证件名称">
                        </div>
...
<script type="text/javascript">
    ...
    $("#addBtn").click(function () {
        ...
        $.ajax({
            ...
            url: "${pageContext.request.contextPath}/cert/doAdd.do",
            beforeSend: function () {
                return true;
            },
