                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <table class="table  table-bordered">
                            ...
                            <tbody>
                            <c:forEach items="${certAll}" var="cert">
                                <tr>
                                    <td>${cert.name}</td>
...
<script type="text/javascript">
    $(function () {
        ...
        <c:forEach items="${queryAcctTypeCerts}" var="cert">
    ...
    $(":checkbox").click(function(){
        ...
        if ( flg ) {
            ...
            $.ajax({
                type : "POST",
                url  : "${pageContext.request.contextPath}/certtype/insertAcctTypeCert.do",
                data : {
                    certid : certid,
                    accttype : accttype
                },
            ...
            $.ajax({
                type : "POST",
                url  : "${pageContext.request.contextPath}/certtype/deleteAcctTypeCert.do",
                data : {
                    certid : certid,
                    accttype : accttype
                },
