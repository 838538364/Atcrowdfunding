...
<script type="text/javascript">
    ...
    $("#passBtn").click(function(){
        $.ajax({
            type : "POST",
            url  : "${pageContext.request.contextPath}/auth_cert/pass.do",
            data : {
                taskid : "${param.taskid}",
                memberid : "${param.memberid}"
            },
            success : function(result) {
                window.location.href = "${pageContext.request.contextPath}/auth_cert/index.htm";
            }
        });
    });
    ...
    $("#refuseBtn").click(function(){
        $.ajax({
            type : "POST",
            url  : "${pageContext.request.contextPath}/auth_cert/refuse.do",
            data : {
                taskid : "${param.taskid}",
                memberid : "${param.memberid}"
            },
